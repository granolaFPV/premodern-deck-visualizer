    ...
    ('diabolic edict', 'tmp', 'ja'): [
        {
            ...
            'image_url': '/static/scans/diabolic_edict_tmp_ja.jpg',
            'image_large': '/static/scans/diabolic_edict_tmp_ja.jpg',
            'set': 'tmp',
            'set_name': 'Tempest',
        ...
        },
        {
            ...
            'image_url': '/static/scans/diabolic_edict_mh1_ja.png',
            'image_large': '/static/scans/diabolic_edict_mh1_ja.png',
            'set': 'mh1',
        ...
        },
        {
            ...
            'image_url': '/static/scans/diabolic_edict_a25_ja.jpg',
            'image_large': '/static/scans/diabolic_edict_a25_ja.jpg',
            'set': 'a25',
            'set_name': 'Masters 25',
            'collector_number': '85',
            'lang': 'ja',
    ...
    ('faerie conclave', 'ulg', 'ja'): [
        {
            ...
            'image_url': '/static/scans/faerie_conclave_ulg_ja.jpg',
            'image_large': '/static/scans/faerie_conclave_ulg_ja.jpg',
            'set': 'ulg',
